...
abstract class AppLocalizations {
  ...
  /// **'Angelos Panagiotakis | Social Links'**
  String get projectTitle;

  /// No description provided for @angelosPanos.
  ///
  /// In pt, this message translates to:
  /// **'Angelos Panagiotakis'**
  String get angelosPanos;

  /// No description provided for @project1_positionInstructor.
  ///
  /// In pt, this message translates to:
  /// **'Flutter Developer Instructor'**
  String get project1_positionInstructor;

  /// No description provided for @hiIAmangelosPanos.
  ///
  /// In pt, this message translates to:
  /// **'Olá, sou Angelos Panagiotakis'**
  String get hiIAmangelosPanos;
  ...
  /// No description provided for @project1.
  ///
  /// In pt, this message translates to:
  /// **'Sua Música | 2022 - Atualmente'**
  String get project1;

  /// No description provided for @project2.
  ///
  /// In pt, this message translates to:
  /// **'Rocketseat | 2021 - 2022'**
  String get project2;

  /// No description provided for @project3.
  ///
  /// In pt, this message translates to:
  /// **'Udemy | 2020 - 2021'**
  String get project3;

  /// No description provided for @project4.
  ///
  /// In pt, this message translates to:
  /// **'Projetos Pessoais | Desde 2020'**
  String get project4;

  /// No description provided for @project1_position.
  ///
  /// In pt, this message translates to:
  /// **'Desenvolvedor Flutter'**
  String get project1_position;

  /// No description provided for @project2_position.
  ///
  /// In pt, this message translates to:
  /// **'Desenvolvedor Instrutor'**
  String get project2_position;

  /// No description provided for @project3_position.
  ///
  /// In pt, this message translates to:
  /// **'Auxiliar de Ensino'**
  String get project3_position;

  /// No description provided for @project4_position.
  ///
  /// In pt, this message translates to:
  /// **'Pagando o preço todos os dias'**
  String get project4_position;
  ...
  /// No description provided for @createdByagelospanagiotakis.
  ///
  /// In pt, this message translates to:
  /// **'Criado por @agelospanagiotakis™'**
  String get createdByagelospanagiotakis;
